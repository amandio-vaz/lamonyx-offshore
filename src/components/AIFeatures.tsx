...
const aiFeatures: AIFeature[] = [
  ...
  },
  {
    ...
    description: "Processamento de milhares de eventos por segundo para agrupar sintomas em uma única causa-raiz. Sua equipe recebe apenas alertas que realmente exigem ação.",
    metric: "-85%",
  ...
  },
  {
    ...
    description: "Ações imediatas predefinidas: bloqueio instantâneo de IPs maliciosos na borda, isolamento automático de portas de rede comprometidas ou rollback instantâneo de imagem de servidores.",
    metric: "< 10s",
