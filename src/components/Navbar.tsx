  ...
  return (
    <header
      className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-theme-card backdrop-blur-xl border-b border-theme shadow-xl"
          : "bg-transparent border-b border-transparent"
      }`}
    >
      <nav className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8 h-20">
        {/* Brand Logo - Horizontal Official Logo */}
        <a href="#top" className="shrink-0 hover:opacity-95 transition-opacity">
          <LamonyxLogo height={38} />
        </a>
        ...
        <div className="hidden xl:flex items-center gap-8">
          <a
            href="#solucoes"
            className="font-mono-tag text-theme-body hover:text-[#38C6D8] transition-colors duration-150 tracking-wider text-xs whitespace-nowrap"
          >
            Soluções
          </a>
          <a
        ...
        <div className="hidden xl:flex items-center gap-4 shrink-0">
          ...
          <button
            onClick={toggleTheme}
            type="button"
            className="relative w-13 h-7 rounded-full bg-theme-alt border border-theme hover:border-[#38C6D8]/60 transition-all flex items-center px-1 group cursor-pointer shrink-0"
          ...
          <a
            href="#contato"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#38C6D8] text-[#0a1420] font-display font-semibold text-xs sm:text-sm hover:bg-theme-heading hover:text-theme-page transition-all shadow-lg shadow-[#38C6D8]/20 whitespace-nowrap"
          >
            Falar com Comercial
          </a>
        </div>
        ...
        <button
          ...
          className="xl:hidden p-2.5 text-theme-heading hover:text-[#38C6D8] rounded-lg transition-colors"
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="xl:hidden bg-theme-card backdrop-blur-2xl border-b border-theme px-6 py-6 space-y-4 shadow-2xl">
          <a
            href="#solucoes"
            onClick={() => setMobileMenuOpen(false)}
            className="block font-mono-tag text-base text-theme-body hover:text-[#38C6D8]"
          >
            Soluções
          </a>
          <a
          ...
          <div className="pt-4 border-t border-theme flex items-center justify-between">
            <span className="font-mono-tag text-xs text-theme-body">Tema de Cores</span>
            <button
              onClick={toggleTheme}
              className="px-4 py-1.5 rounded-full bg-theme-alt border border-theme text-xs text-[#38C6D8] font-mono font-bold"
            >
